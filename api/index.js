...
module.exports = async (req, res) => {
    // 1. Ustawienia nagłówków CORS (pozwala na połączenie z Twoją stroną)
    ...
    req.on('end', async () => {
        try {
            ...
            // 2. Pobranie tokena dostępu z Bitwarden
            ...
            const tokenRes = await makeHttpsRequest({
                ...
                headers: { 
                    ...
                    'Bitwarden-Client-Version': '2024.0.0' // Wymagany nagłówek
                }
            }, tokenStr);
            ...
            // 3. Przygotowanie notatki do zapisu
            ...
            // 4. Zapis do sejfu (z wymaganymi nagłówkami)
            const cipherOptions = {
                ...
                headers: {
                    ...
                    'Device-Type': '1', // Wymagany typ urządzenia
                    'Bitwarden-Client-Version': '2024.0.0', // Wymagana wersja
            ...
            // 5. Odpowiedź do aplikacji
            if (postRes.statusCode >= 200 && postRes.statusCode < 300) {
                return res.status(200).json({ success: true, message: "Zapisano pomyślnie!" });
            } else {
                return res.status(postRes.statusCode).json({ error: "API Bitwarden odrzuciło zapis", details: postRes.body });
            }
        } catch (e) {
